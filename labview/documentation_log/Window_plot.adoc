...
image::../dev_labview/Documentation_vi/Windows_plot_LocalMode_1.PNG[Local mode in Window_plot.vi]
...
image::../dev_labview/Documentation_vi/Windows_plot_LocalMode_2.PNG[Local mode in Window_plot.vi]
...
image::../dev_labview/Documentation_vi/Windows_plot_fromFile.png[Get signal from file in Window_plot.vi]
